...
def render_navbar():
    ...
    if is_admin:
        ...
        nav_pages = ['dashboard', 'assessments', 'candidates', 'admin_panel', 'admin_settings', 'settings']
        nav_labels = ['Dashboard', 'Assessments', 'Candidates', 'Admin Panel', 'Admin Settings', 'Settings']
    else:
